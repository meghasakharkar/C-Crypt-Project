<%@ Page Title="" Language="C#" MasterPageFile="~/users.master" AutoEventWireup="true" CodeFile="downloadfile.aspx.cs" Inherits="downloadfile" %>

<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder3">
    <table>
        <tr>
            <td>
                <asp:Label ID="Label1" runat="server" Text="Download file" Font-Names="Calibri" Font-Size="X-Large" ForeColor="#006666"></asp:Label></td>
        </tr>
    </table>
    <br />
    <table>
        ...
        <tr>
            ...
            <td style="text-align: right">
                <asp:ImageButton ID="IBtnDownload" runat="server" Height="50px" ImageUrl="~/Images/download.png" OnClick="IBtnDownload_Click" /></td>
            <td></td>
        </tr>
        <tr>
            <td colspan="3">
